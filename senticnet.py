...
#it is a dictionary trained methods or machine learning methods, It maintains a dictionary with sentiments of words
class SenticNet(object):
    """
    Simple API to use SenticNet 5.
    """
    def __init__(self, language="en"):
        data_module = importlib.import_module("data_en")
